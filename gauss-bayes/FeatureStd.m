...
pswdata=table_creation("data/walking-priya.xls","walking");
aswdata = table_creation('data/walking_data_(flat)_auri.xls',"walking");
sswdata=table_creation('data/walking(flat)_sharon.xls', "walking");

%%
%Running Data

psrdata=table_creation('data/running-priya.xls',"running");
asrdata=table_creation('data/auri_run.xls',"running");
ssrdata= table_creation('data/running(flat)_sharon.xls',"running");
%%
%Jumping data

psjdata= table_creation('data/jumping-priya.xls',"jumping");
asjdata=table_creation('data/auri_jump.xls',"jumping");
ssjdata=table_creation('data/jumping(flat)_sharon.xls',"jumping");

%%
%Combine standard deviation data
Featuresstd=[pswdata;psrdata;psjdata;aswdata;asrdata;asjdata;sswdata;ssrdata;ssjdata]
[trainedClassifier, validationAccuracy] = trainClassifier(Featuresstd)
%%
...
% Auto-generated by MATLAB on 10-May-2021 18:31:05
...
predictorNames = {'sA_x', 'sA_y', 'sA_z', 'sA_abs'};
...
trainedClassifier.RequiredVariables = {'sA_abs', 'sA_x', 'sA_y', 'sA_z'};
...
awalkingdata.Properties.VariableNames = ["sA_x","sA_y","sA_z","sA_abs","Motion"];
